...
CS.EP.U3D.UTIL.XObject.This = function () {
...
CS.EP.U3D.UTIL.XObject.HashCode = HashCode
CS.EP.U3D.UTIL.XObject.TypeOf = puer.$typeof
//#endregion

//#region XString
CS.EP.U3D.UTIL.XString.Format = function (fmt, ...args) {
    if (fmt) {
        if (args.length > 0) {
            let index = 0
...
//#region XLog
const _Emergency = CS.EP.U3D.UTIL.XLog.Emergency
const _Alert = CS.EP.U3D.UTIL.XLog.Alert
const _Critical = CS.EP.U3D.UTIL.XLog.Critical
const _Error = CS.EP.U3D.UTIL.XLog.Error
const _Warn = CS.EP.U3D.UTIL.XLog.Warn
const _Notice = CS.EP.U3D.UTIL.XLog.Notice
const _Info = CS.EP.U3D.UTIL.XLog.Info
const _Debug = CS.EP.U3D.UTIL.XLog.Debug

const isDebug = CS.EP.U3D.UTIL.XEnv.Mode == CS.EP.U3D.UTIL.XEnv.ModeType.Dev ||
...
CS.EP.U3D.UTIL.XLog.Emergency = function (...args) {
    if (isDebug) {
...
CS.EP.U3D.UTIL.XLog.Alert = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
CS.EP.U3D.UTIL.XLog.Critical = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
CS.EP.U3D.UTIL.XLog.Error = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
CS.EP.U3D.UTIL.XLog.Warn = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
CS.EP.U3D.UTIL.XLog.Notice = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
CS.EP.U3D.UTIL.XLog.Info = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
CS.EP.U3D.UTIL.XLog.Debug = function (...args) {
    if (isDebug) {
        if (args != null && args.length > 0 && typeof (args[0]) == "string") {
            args[0] += "\n" + genTrace()
        }
...
//#region XComp
const _GetTransform = CS.EP.U3D.UTIL.XComp.GetTransform
const _GetComponent = CS.EP.U3D.UTIL.XComp.GetComponent
const _GetComponentInParent = CS.EP.U3D.UTIL.XComp.GetComponentInParent
const _GetComponentInChildren = CS.EP.U3D.UTIL.XComp.GetComponentInChildren
const _GetComponents = CS.EP.U3D.UTIL.XComp.GetComponents
const _GetComponentsInParent = CS.EP.U3D.UTIL.XComp.GetComponentsInParent
const _GetComponentsInChildren = CS.EP.U3D.UTIL.XComp.GetComponentsInChildren
const _RemoveComponent = CS.EP.U3D.UTIL.XComp.RemoveComponent
const _AddComponent = CS.EP.U3D.UTIL.XComp.AddComponent
const _SetComponentEnabled = CS.EP.U3D.UTIL.XComp.SetComponentEnabled
const MonoBehaviour = CS.UnityEngine.MonoBehaviour

CS.EP.U3D.UTIL.XComp.GetComponent = function (parentObj, pathOrType, typeOrAttach = false, attachIfMissing = false) {
...
CS.EP.U3D.UTIL.XComp.GetComponentInParent = function (parentObj, pathOrType, typeOrInclude = false, includeInactive = false) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
CS.EP.U3D.UTIL.XComp.GetComponentInChildren = function (parentObj, pathOrType, typeOrInclude = false, includeInactive = false) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
CS.EP.U3D.UTIL.XComp.GetComponents = function (parentObj, pathOrType, type) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
CS.EP.U3D.UTIL.XComp.GetComponentsInParent = function (parentObj, pathOrType, typeOrInclude = false, includeInactive = false) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
CS.EP.U3D.UTIL.XComp.GetComponentsInChildren = function (parentObj, pathOrType, typeOrInclude = false, includeInactive = false) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
CS.EP.U3D.UTIL.XComp.RemoveComponent = function (parentObj, pathOrType, typeOrImmediate = false, immediate = false) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
CS.EP.U3D.UTIL.XComp.AddComponent = function (parentObj, pathOrType, type) {
    if (typeof pathOrType === "string") {
...
CS.EP.U3D.UTIL.XComp.SetComponentEnabled = function (parentObj, pathOrType, typeOrEnabled, enabled) {
    if (typeof pathOrType === "string") {
        let root = _GetTransform(parentObj, pathOrType)
...
//#region XEvent
const XLog = CS.EP.U3D.UTIL.XLog
const XEvent = CS.EP.U3D.UTIL.XEvent
